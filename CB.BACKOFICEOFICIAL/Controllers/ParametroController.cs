...
namespace CB.BACKOFICEOFICIAL.Controllers
{
	...
	{
		LOGICA.LParametro lg = new LOGICA.LParametro();
		// GET: Parametro
		...
		{
			LOGICA.LTipoGetion tp = new LOGICA.LTipoGetion();
			var obj = new ENTIDADES.Parametro();
			ViewBag.TipoGestionId = new SelectList(tp.ListAll(), "tipoGestionID", "Nombre");
		...
		[HttpPost]
		public ActionResult Create(ENTIDADES.Parametro collection)
		{
		...
		public ActionResult Edit(int id)
		{
			...
			LOGICA.LTipoGetion tp = new LOGICA.LTipoGetion();
			var obj = list.Where(x => x.ID == id).FirstOrDefault();
			ViewBag.TipoGestionId = new SelectList(tp.ListAll(), "tipoGestionID", "Nombre", obj.TipoGestionId);
			if (obj != null)
			{
		...
		[HttpPost]
		public ActionResult Edit(ENTIDADES.Parametro collection)
		{
			var mensajes = new List<KeyValuePair<string, string>>();
			try
			{

...
/***/ function(module, exports, __webpack_require__) {
	...
	var GridPanel = (function () {
		...
		GridPanel.prototype.createNoRowsOverlayTemplate = function () {
			...
			var localeTextFunc = this.gridOptionsWrapper.getLocaleTextFunc();
			var templateLocalised = templateNotLocalised.replace('[NO_ROWS_TO_SHOW]', localeTextFunc('noRowsToShow', 'No hay filas para Mostar'));
			return templateLocalised;
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var template = '<div class="ag-paging-panel">' +
			...
			'<button type="button" class="ag-paging-button" id="btFirst"><i class="fa fa-step-backward"></i></button>' +
			'<button type="button" class="ag-paging-button" id="btPrevious"><i class="fa fa-backward"></i></button>' +
			'[PAGE] ' +
			'<span id="current"></span>' +
			' [OF] ' +
			'<span id="total"></span>' +
			'<button type="button" class="ag-paging-button" id="btNext"><i class="fa fa-forward"></i></button>' +
			'<button type="button" class="ag-paging-button" id="btLast"><i class="fa fa-step-forward"></i></button>' +
			'</span>' +
			'</div>';
	var PaginationController = (function () {
		...
		PaginationController.prototype.createTemplate = function () {
			...
			return template
				...
				.replace('[TO]', localeTextFunc('to', 'Hasta'))
				.replace('[OF]', localeTextFunc('of', 'De'))
				.replace('[OF]', localeTextFunc('of', 'of'))
				.replace('[FIRST]', localeTextFunc('first', 'Primero'))
				.replace('[PREVIOUS]', localeTextFunc('previous', 'Anterior'))
				.replace('[NEXT]', localeTextFunc('next', 'Siguiente'))
				.replace('[LAST]', localeTextFunc('last', 'Ultimo'));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EnterpriseMenu = (function () {
		...
		EnterpriseMenu.prototype.createPinnedSubMenu = function () {
			...
			var localeTextFunc = this.gridOptionsWrapper.getLocaleTextFunc();
			cMenuList.addItem({
				name: localeTextFunc('pinLeft', 'Fijar izquierda'),
			...
			cMenuList.addItem({
				name: localeTextFunc('pinRight', 'Fijar derecha'),
			...
			cMenuList.addItem({
				name: localeTextFunc('noPin', 'No fijar'),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SetFilter = (function () {
		...
		SetFilter.prototype.createTemplate = function () {
			return template
				.replace('[SELECT ALL]', this.localeTextFunc('selectAll', 'Seleccionar todo'))
				.replace('[SEARCH...]', this.localeTextFunc('searchOoo', 'Buscando...'))
				.replace('[APPLY FILTER]', this.localeTextFunc('applyFilter', 'Aplicar Filtro'));
		};
